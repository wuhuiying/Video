...
public class QuarterVideoRecorderView extends LinearLayout implements MediaRecorder.OnErrorListener {
    ...
    public QuarterVideoRecorderView(Context context) {
        super(context, null);
        this.context = context;
    }

    public QuarterVideoRecorderView(Context context, AttributeSet attrs) {
    ...
    public QuarterVideoRecorderView(Context context, AttributeSet attrs, int defStyleAttr) {
