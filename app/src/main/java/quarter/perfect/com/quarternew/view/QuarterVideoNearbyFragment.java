...
public class QuarterVideoNearbyFragment extends BaseMvpFragment<QuarterVideoHotFragment,QuarterVideoHotPresenter> implements QuarterJieKou.QuarterVideoHot_V {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.quarter_video_nearby_fragment, container, false);
        hot_xrv = view.findViewById(R.id.quarter_video_nearby_xrv);
