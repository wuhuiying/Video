...
public class QuarterRewritePopwindow extends PopupWindow {
    private View mView;

    public QuarterRewritePopwindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
    ...
    private void initView(final Activity context, View.OnClickListener itemsOnClick) {
        ...
        mView = mInflater.inflate(R.layout.quarter_popupwindow_share, null);
